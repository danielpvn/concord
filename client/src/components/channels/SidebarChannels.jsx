...
export const SidebarChannels = () => {
  const { channels, activeChannelId, joinChannel, onlineUsers, adminMoveUser } = useSocket();
  ...
  return (
    <aside
      className={`relative flex flex-col h-full bg-gaming-900 border-r border-gaming-800 transition-all duration-300 z-30 ${
            ...
            {voiceChannels.map(channel => {
              ...
              return (
                ...
                >
                  ...
                  {isExpanded && usersInRoom.length > 0 && (
            ...
            {textChannels.map(channel => {
              ...
              return (
                ...
                >
                  ...
                  {isExpanded && <span className="text-xs truncate">{channel.name}</span>}
                </button>
              );
            })}
          </div>
